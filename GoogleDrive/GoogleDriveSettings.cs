...
namespace GoogleDrive
{
    [ORMEntity]
    [DataContract]
    public class GoogleDriveSettings : AbstractModuleSettings
    {
        public GoogleDriveSettings()
        {
            EntityName = "GoogleDrive Custom App Settings";
        }
        ...
        public override BaseActionType[] GetActions(AbstractUserContext userContext, EntityActionType[] types)
        {
            ...
            results.Add(new EditObjectAction(typeof(GoogleDriveSettings), "Edit", null, "Edit", ()=> { return this; }, SaveChanges));
